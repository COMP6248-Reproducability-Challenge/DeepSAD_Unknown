# This work forked by DeepSAD
we modified some baseline models and changed the training device.
Basically, we changed the parameters to test the model based on different datasets.
